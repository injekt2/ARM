...
<div class="header_title">
	...
	<p>Выберете критерий,для проведения оценки условий труда.</p>
</div>
...
<?php
	$user_id = $_GET["id"];
?>
	<div class="item_ocenki">
		<a href="APFD&id=<?php echo $user_id?>">АПФД</a>
	</div>
	<div class="item_ocenki">
		<a href="microcliomat&id=<?php echo $user_id?>">МИКРОКЛИМАТ</a>
	</div>
	<div class="item_ocenki">
		<a href="IIt&id=<?php echo $user_id?>">ИИ</a>
	</div>
	<div class="item_ocenki">
		<a href="EMIt&id=<?php echo $user_id?>">ЭМИ</a>
	</div>
</div>
</section>
